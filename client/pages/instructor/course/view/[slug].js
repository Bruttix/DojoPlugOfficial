  ...
  return (
    <InstructorRoute>
      <div className="contianer-fluid pt-3">
        ...
        {course && (
          <div className="container-fluid pt-1 instructCoursesBanner">
            ...
            <div className="row">
              <div className="col">
                <ReactMarkdown source={course.description} className="instructorCourseDesc"/>
              </div>
            </div>
            <div className="row">
              <Button
                onClick={() => setVisible(true)}
                className="col-md-6 offset-md-3 text-center loginButton"
                type="primary"
                shape="round"
                icon={<UploadOutlined />}
                size="large"
