...
import {
  ...
  MenuUnfoldOutlined,
  CheckCircleFilled,
  MinusCircleFilled, IssuesCloseOutlined , CheckOutlined ,
...
const SingleCourse = () => {
  ...
  return (
    <StudentRoute>
      <div className="row courseLesson">
        <div style={{ maWidth: 320 }} className="courseLesson">
          <Button
            onClick={() => setCollapsed(!collapsed)}
            className="text-primary mt-1 btn-block mb-2 courseLessonBtn"
          >
            ...
            <>
              <div className="col alert alert-primary square">
                ...
                {completedLessons.includes(course.lessons[clicked]._id) ? (
                  ...
                  >
                    <IssuesCloseOutlined />   Mark as Incomplete
                  </span>
                ) : (
